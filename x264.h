...
#include <time.h>
     ...
     //宏定义
#define QPA_SIZE                          64
#define QPA_SIMD                          1//hp-aq QPA汇编
#define global                            1//全局优化
...
//=======================================
#define gaussian_new_avx2         1//高斯滤波汇编




#define ONLY_SSIM_LAMBDA        0
#define SSIM_QUANTIZATION_SIMD  0
#define   PI                    3.14159265
#define   SSIM_AQ_SIZE          16
#define   MIN_SSIM_AQ_SIZE      8
typedef struct ssimquant_t
{
    double* afFactor;
    int           iStride;
    int           iWidth;
...
#define X264_AQ_QPA                  4



#define X264_SSIM_AQ                 5
