...
REALIGN_STACK void x264_param_default( x264_param_t *param )
{
    ...
    param->SSIM1 = 0;
    param->GAUSSIAN1 = 0;
    param->GAUSSIAN1_STRENGTH = 0.5;//Ĭ��Ϊ0.3
    param->JND1 = 0;
...
static int param_apply_preset( x264_param_t *param, const char *preset )
{
    ...
    if( !strcasecmp( preset, "ultrafast" ) )
    {
        ...
        param->rc.i_aq_mode = 0;//�������ultrafastģʽ���������У������ֵ��Ϊ��0ֵ encoder.c1177��Ӧ�ø�Ϊclip��0,4����Ϊ�����Լ�������һ��ģʽ4
...
#define OPT2(STR0, STR1) else if( !strcmp( name, STR0 ) || !strcmp( name, STR1 ) )
    ...
    {
        p->GAUSSIAN1 = 1;
        p->GAUSSIAN1_STRENGTH = atof(value);
        printf("gauss-filter start,GAUSSIAN1_STRENGTH=%f\n",p->GAUSSIAN1_STRENGTH);
    }
    OPT("his-equ")
    {
        p->HistogramEqualization1 = 1;
    ...
    OPT("aq-mode")
        p->rc.i_aq_mode = atoi(value);//wjf test
    OPT("aq-strength")
